/*
	...
	Date:         	20-Feb-2014
	Version:      	0.0.2 ALPHA Lynxmotion's BotBoarduino and SSC-32
...
*/
void initMotors (ServoMotor *left, ServoMotor *right) {
	console.println("Initializing Motors..");

	setMotorSpeed(left, SERVO_MOTOR_LEFT_NEUTRAL, false);
	setMotorSpeed(right, SERVO_MOTOR_RIGHT_NEUTRAL, true);
}
